...
SECRET_KEY = '%458a)a(qh&d9t2qk^zpc8(t#(f_f6x6@f6#=+347y_$n@_br4'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "django.template.context_processors.media" # this line imports the media context processor for use in templates
            ],
        },
    },
]
